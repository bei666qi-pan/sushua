...
from .contracts import SourceReference, StrictModel, uuid_v7


class DoclingConvertRequest(StrictModel):
...
class DoclingConvertResult(StrictModel):
...
class DoclingConvertResponse(StrictModel):
    schema_version: Literal[1] = Field(alias="schemaVersion", default=1)
    result: DoclingConvertResult
