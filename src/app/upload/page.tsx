...
import type { DraftQuestion, QType, Visibility } from "@/lib/types";
              ...
              <div key={i} className="rounded-xl border border-line bg-card p-4">
                <div className="flex items-center justify-between gap-2">
                  <div className="flex items-center gap-2">
                    <span className="text-xs text-ink-faint">第 {i + 1} 题</span>
                    <select
                      value={q.type}
                    ...
                    {q.options.map((opt, oi) => (
                      <div key={oi} className="flex items-center gap-2">
                        ...
                        <input
                          value={opt}
                          onChange={(e) =>
                            patchQ(i, { options: q.options.map((o, j) => (j === oi ? e.target.value : o)) })
                          }
